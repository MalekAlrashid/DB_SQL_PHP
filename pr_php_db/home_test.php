...
?>    
        ...
        <form method="POST" action="">
            <aside> <!-- Daten des neuen Kunde-->
                <div id='div'>
                    ...
                    <label> ID:</label><br>
                    <select name="id" id='id' type= 'hidden' >
                        <?php
                    ...
                    <button name = 'edit' id='edit'> Aktolaisieren</button><br><br>
                    <form action="" method="post" id= 'search'><br>
                    <input type="text" name="search"><br>
                    <button type="submit" name="submit" value="Search">Suche</button><br>
                    </form>
                </div>
            ...
            <div><h4>Aktuelle Tabelle: <span>KUNDE</span></h4></div>
            <table id= 'tpl'>
            <tr>
            <th>  ID     </th>
            <th>  Kundennummer     </th>
    ...
    function test(){
            if($name = ''){// Name
                ...
                echo 'alert("Bitte füge einen gültigen Namen")';  //Name is empty
                echo '</script>'; 
            }
            else if($contnm = ''){ //Kontaktname
                echo '<script language="javascript">';
                echo 'alert("Bitte füge einen gültigen Namen")';  //Contact name is empty
                echo '</script>'; 
            }
            else if($address= ''){ //Adresse
                echo '<script language="javascript">';
                echo 'alert("Bitte füge ein gültige Adresse")';  //Address is empty
                echo '</script>'; 
            }
            else if($city= ''){ //Stadt
                echo '<script language="javascript">';
                echo 'alert("Bitte füge eine gültige Stadt")';  //City is empty
                echo '</script>'; 
            }
            else if($postal= ''){ //Postleizahl
                echo '<script language="javascript">';
                echo 'alert("Bitte füge eine gültigen Postleizahl")';  //Postalcode is empty
                echo '</script>'; 
            }else if($country= ''){ //Land
                echo '<script language="javascript">';
                echo 'alert("Bitte füge einen gültigen Landsnamen")';  //Country is empty
                echo '</script>'; 
            }else{
                echo '<script language="javascript">';
                // add
                echo "document.getElementById('add').onclick = function(){
